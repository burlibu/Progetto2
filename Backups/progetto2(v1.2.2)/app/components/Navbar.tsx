    ...
    <nav className="bg-gray-800 p-4 fixed top-0 w-full z-10">
      <div className="flex justify-between items-center">
        ...
        <ul className="flex space-x-4">
          ...
          {isAuthenticated ? (
            <>
              <li><Link href="/home" className="text-white hover:text-gray-300">Dashboard</Link></li>
              <li><button onClick={handleLogout} className="text-white hover:text-gray-300 bg-transparent">Logout</button></li>
            </>
          ) : (
            <>
